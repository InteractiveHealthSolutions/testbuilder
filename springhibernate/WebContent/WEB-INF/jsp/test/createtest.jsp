  ...
  <div class="container">
    ...
    <div class="row clearfix">
      ...
      <div class="col-md-9 column">
        <h3>Create Test</h3>
        <form:form id="frmSubmitQuestion" method="POST" action="/springhibernate/test/createtest" modelAttribute="newTest">
    ...
    <table border="1px" class="table table-bordered">
      ...
      <tr>
        <td>
          ...
          <form:select id="slctQuestion" path="questionList" items="${loadedQuestionList}" itemLabel="title"
            itemValue="id" onclick="getQuestionData()" class="form-control input"/>
