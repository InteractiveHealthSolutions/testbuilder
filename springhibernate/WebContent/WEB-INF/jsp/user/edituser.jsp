					...
					<div class="row">
						...
						<div class="control-group">
							<div class="col-md-6">
								<input type="hidden" name="creatorId"
									value="${editUser.getCreatorId()}" /> <input type="hidden"
									name="lastEditorId" value="${currentUser.getId()}" />
						...
						<div class="control-group">
							<div class="col-md-6">
								...
								<form:input path="login_Id" class="form-control input"
									placeholder="Login Id" required="true" />
								<form:errors path="name" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="control-group">
							<div class="col-md-6">
								...
								<form:input path="password" class="form-control input"
						...
						<div class="control-group">
							<div class="col-md-6">
								<div class="text-center">
									...
									<input type="submit" value="Update" id="singlebutton"
							...
							<div class="col-md-6">
								<div class="text-center">
									<a href="manageuser"><input type="button"
